...
app.post('/urls', (req, res) => {
  ...
  if (!userId || !users[userId]) {
    return res
      .status(403)
      .send(
        '<h2>You must be Registered and Logged in to create a short URL. Please Log in</h2>'
      );
  }
...
app.get('/urls/:id', (req, res) => {
  ...
  if (!url) {
    return res
      .status(404)
      .send('<h2>URL not found. Could be deleted or Does Not Exist</h2>');
  }
...
app.get('/u/:id', (req, res) => {
  ...
  if (url) {
    ...
    res
      .status(404)
      .send(
        '<h2>404 - URL not found in database. Please check and try again</h2>'
      ); // Handle 404 Error
  }
});
...
app.post('/urls/:id/delete', (req, res) => {
  ...
  if (url.userId !== userId) {
    return res
      .status(403)
      .send("<h2>You don't have permission to delete this URL</h2>");
  }
...
app.post('/urls/:id', (req, res) => {
  ...
  if (url.userId !== userId) {
    return res
      .status(403)
      .send("<h2>You don't have permission to edit this URL</h2>");
  }
...
app.post('/register', (req, res) => {
  ...
  if (!email || !password) {
    return res
      .status(400)
      .send('<h2>Please enter valid Email and Password</h2>');
  }
  ...
  if (existingUser) {
    return res
      .status(400)
      .send('<h2>Email is registered already. Please Log in</h2>');
  }
